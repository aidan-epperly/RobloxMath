...
local symbolicAlgebraDev = {}

symbolicAlgebraDev.set = {}

symbolicAlgebraDev.set.new = function (array)
    return _setFromArray(array)
end

symbolicAlgebraDev.duple = {}

symbolicAlgebraDev.duple.new = function (first, second)
    return _dupleFromTwoInputs(first, second)
end

symbolicAlgebraDev.monomial = {}

symbolicAlgebraDev.monomial.new = function (exponents, symbols, coeff)
    return _monomialFromArrayAndPreSet(exponents, symbols, coeff)
end

symbolicAlgebraDev.monomial.copy = function (monomial)
    return _monomialCopy(monomial)
end

symbolicAlgebraDev.monomial.replace = function (monomial, symbolToReplace, symbol)
    return _monomialReplace(monomial, symbolToReplace, symbol)
end

symbolicAlgebraDev.monomial.scale = function (c, monomial)
    return _monomialScale(c, monomial)
end

symbolicAlgebraDev.monomial.simplify = function (monomial)
    return _monomialSimplify(monomial)
end

symbolicAlgebraDev.monomial.evaluate = function (monomial, rules)
    return _monomialEvaluate(monomial, rules)
end

symbolicAlgebraDev.polynomial = {}

symbolicAlgebraDev.polynomial.new = function (array)
...
symbolicAlgebraDev.polynomial.copy = function (polynomial)
    return _polynomialCopy(polynomial)
end

symbolicAlgebraDev.polynomial.replace = function (polynomial, symbolToReplace, symbol)
    return _polynomialReplace(polynomial, symbolToReplace, symbol)
end

symbolicAlgebraDev.polynomial.scale = function (c, polynomial)
    return _polynomialScale(c, polynomial)
end

symbolicAlgebraDev.polynomial.simplify = function (polynomial)
    return _polynomialSimplify(polynomial)
end

symbolicAlgebraDev.polynomial.evaluate = function (polynomial, rules)
    return _polynomialEvaluate(polynomial, rules)
end

return symbolicAlgebraDev